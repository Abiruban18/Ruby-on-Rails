...
class Library
  ...
  # Task: Expose all_books reader to allow external saving mechanics
  attr_reader :books
...
def save_library(library)
  ...
  puts "\n[System] Library data safely persisted to disk."
end
...
# Task: Load library dataset before the loop sets up
load_library(library)

# Task: at_exit Block acts as an untouchable global exit strategy safety net
at_exit do
